...
const Contact = () => {
    // const prefix = "+94-"
    const [studentInfo, setPStudentInfo] = useState({
        email: "",
        password: ""
    });
            ...
            <div name='contact' className='w-full h-screen  flex flex-col justify-between'>
                <div className='grid md:grid-cols-2 max-w-[1240px] m-auto'>
                    <div className='flex flex-col justify-center md:items-start w-full px-2 py-8'>
                        ...
                        <h1 className='py-3 text-3xl md:text-5xl font-bold mt-5'>Contact Us</h1>
                        <p className='text-2xl text-gray-400'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eius tempor incididunt ut labore et dolore magna aliqua. Ut enim adiqua minim veniam quis nostrud exercitation ullamco</p>
                        {/* <div class="w-full">
                        <h4 class="font-bold text-dark text-xl mb-1">Phone Number</h4>
                        <p class="text-base text-body-color">(+62)81 414 257 9980</p>
                    </div> */}
                        <div className="flex mb-8 max-w-[370px] w-full mt-2">
                            <div
                                className="
                     max-w-[60px]
                     sm:max-w-[70px]
                    ...
                    <div className="bg-white  rounded-lg p-8 sm:p-12  md:mt-12">
                        <form>
                            <div className="mb-6">
                                <input
                                    type="text"
                                    placeholder="Your Name"
                                    className="w-full rounded  py-3 px-[14px]
                        ...
                        "
                            ...
                            <datalist id="qualification">
                                ...
                                <select className="form-select appearance-none
                                    ...
                                    defaultValue={{ label: "Educational Qualification" }}>
                                    {/* <option selected>Educational Qualifications</option> */}
